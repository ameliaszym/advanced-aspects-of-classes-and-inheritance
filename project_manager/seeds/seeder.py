class Seeder:
    def __init__(self, team_service, task_service):
    ...
    def seed(self):
        ...
        self.task_service.add_comment(task1, "Remember to use secure password hashing.")
        self.task_service.add_comment(task1, "Add unit tests for login.")
        self.task_service.add_comment(task2, "Bug appears only on mobile.")
        self.task_service.add_comment(task3, "Dashboard should support dark mode.")
